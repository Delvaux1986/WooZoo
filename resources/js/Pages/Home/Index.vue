                ...
                <tr>
                    ...
                    <td>
                        <div class="form-check form-switch d-flex justify-content-center">
                            <input v-if="specie.feedSpecie === 1" class="form-check-input" type="checkbox" id="specieFirstLunchtime" checked :v-model="specieFirstLunchtime" @change="changeFirstLunchtime(specie)" />
                            <input v-else class="form-check-input" type="checkbox" id="specieFirstLunchtime" :v-model="specieFirstLunchtime" @change="changeFirstLunchtime(specie)" />
                    ...
                    <td>
                        <div class="form-check form-switch d-flex justify-content-center">
                            <input v-if="specie.feedSpecieTwo" class="form-check-input" type="checkbox" id="specieSecondLunchtime" checked :v-model="specieSecondLunchtime" @change="changeSecondLunchtime(specie)" />
                            <input v-else class="form-check-input" type="checkbox" id="specieSecondLunchtime" :v-model="specieSecondLunchtime" @change="changeSecondLunchtime(specie)" />
                        </div>
        ...
        <table class="table text-center table-bordered">
            ...
            <tbody v-for="pet in this.animals" :key="pet.id">
                <tr>
                    ...
                    <td>
                        <div class="form-check form-switch d-flex justify-content-center">
                            <input v-if="pet.feeds ===1" class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" checked :v-model="petFeed" @change="changePetFeed(pet)" />
                            <input v-else class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" :v-model="petFeed" @change="changePetFeed(pet)" />
                        </div>
                    </td>
...
export default {
    ...
    methods: { // 3 METHODS FOR UPDATE FEED ON SPECIE & ANIMAL
